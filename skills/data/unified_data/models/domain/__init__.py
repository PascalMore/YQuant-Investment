...
Eight dataclasses covering the eight TA-CN MongoDB collections in scope
for Phase 1A (DESIGN-03-007 §Phase 1A / SPEC-03-007 §4).
...
__all__ = [
    ...
    # Phase 3 P3-A (T3-A): sector / industry snapshot canonical record.
    "SectorSnapshot",
